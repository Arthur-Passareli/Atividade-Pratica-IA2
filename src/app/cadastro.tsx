...
export default function CadastroScreen() {
    ...
    const [form, setForm] = useState<{data: Form, errors: Error}>({
        data: {fullName: "", role: "", company: "", experience: 0, technology: "", cardColor: ""},
        errors: {}
    })
    ...
    function handleSetOrRemoveInputError(name: keyof Form, error: string | undefined) {
        setForm((currentForm)   => {
            return {
                ...currentForm,
                errors: {
