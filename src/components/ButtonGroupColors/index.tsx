    ...
    return (
        <View style={styles.buttonGroupContainer}>
            {group.map((item) => (
                ...
                key={item.id} style={[styles.buttonGroupButtonContainer, selected?.id === item.id && { borderColor: item.colorCode }]}>
                    <View style={[styles.buttonGroupColorIndicator, { backgroundColor: item.colorCode }]} />
                    <Text style={[
